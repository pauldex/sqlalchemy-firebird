...
# https://ib-aid.com/download/docs/firebird-language-reference-2.5/fblangref25-reskeywords-reswords.html
RESERVED_WORDS_259 = set(
    [
        "add",
        "admin",
        "all",
...
class FBIdentifierPreparer(sql.compiler.IdentifierPreparer):
    ...
    reserved_words = RESERVED_WORDS_4
...
class FBDialect(default.DefaultDialect):
    ...
    def initialize(self, connection):
        ...
        """
            ...
            Reserved words in Firebird 5 are the same as those in Firebird 4
        """
        if self.server_version_info < (4,):
            self.max_identifier_length = 31
            if self.server_version_info < (3,):
                self.preparer.reserved_words = RESERVED_WORDS_259
            else:
                self.preparer.reserved_words = RESERVED_WORDS_3
        else:
            self.max_identifier_length = 252
            self.preparer.reserved_words = RESERVED_WORDS_4
