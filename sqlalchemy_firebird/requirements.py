# Please keep this module as close as possible in sync with SQLAlchemy own
#   testing/requirements.py
# as this would ease future maintenance.
...
from sqlalchemy.testing import only_on
from sqlalchemy.testing.requirements import SuiteRequirements


class Requirements(SuiteRequirements):
    #
    # From class SuiteRequirements
    #
    ...
    def duplicate_key_raises_integrity_error(self):
        ...
        # Firebird drivers does not raises IntegrityError.
        return exclusions.closed()
    ...
    def unicode_data(self):
        ...
        # This assumes ?charset=UTF8 in connection URI
        return exclusions.open()
    ...
    #
    # From class DefaultRequirements
    #
